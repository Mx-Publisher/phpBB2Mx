...
class GoogleConnect extends SocialConnect
{
	...
	public function __construct($network_name)
	{
		...
		include_once($phpbb_root_path . "includes/auth/google/autoload.".$phpEx);

		$app_id = $board_config['google_app_id'];
		$app_secret = $board_config['google_app_secret'];
	...
	public function get_user_data()
	{
		...
		try
		{
			...
			$google_client = $this->client->verifyIdToken()->getAttributes();
			$google_user_id = $google_client['payload']['sub'];
