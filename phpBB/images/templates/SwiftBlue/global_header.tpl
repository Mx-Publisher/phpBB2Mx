...
<link rel="top" href="http://caleacrestina.uv.ro/forum/index.php" title="Pagina de start a forumului caleacrestina.uv.ro" />
<link rel="search" href="http://caleacrestina.uv.ro/forum/search.php" title="Cãutare" />
<link rel="help" href="http://caleacrestina.uv.ro/forum/faq.php" title="FAQ" />
<link rel="author" href="http://caleacrestina.uv.ro/forum/memberlist.php" title="Membri" />
...
/*
  This is for the table cell above the Topics, Post & Last posts on the http://caleacrestina.uv.ro/forum/index.php page
...
/* Forum title: Text and link to the forums used in: http://caleacrestina.uv.ro/forum/index.php */
...
function checkSearch()
{
	...
	{
		window.open('http://caleacrestina.uv.ro/forum/index.php?page=5&mode=results&search_terms=all&search_keywords=' + document.search_block.search_keywords.value, '_self', '');
		return false;
	}
	else if (document.search_block.search_engine.value == 'kb')
	{
		window.open('http://caleacrestina.uv.ro/forum/index.php?page=&mode=search&search_terms=all&search_keywords=' + document.search_block.search_keywords.value, '_self', '');
		return false;
	}
	else if (document.search_block.search_engine.value == 'pafiledb')
	{
		window.open('http://caleacrestina.uv.ro/forum/index.php?page=&action=search&search_terms=all&search_keywords=' + document.search_block.search_keywords.value, '_self', '');
		return false;
	}
	else
	{
